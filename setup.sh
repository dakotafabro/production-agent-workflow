...
echo ""
echo -e "  ${CYAN}Tip:${NC} Open ${BOLD}prompts.md${NC} for copy-paste prompts you can give your agent"
echo "  to help fill in the remaining conventions. Your agent can analyze your"
echo "  codebase, CI config, and test suite to populate these files for you."
echo ""
